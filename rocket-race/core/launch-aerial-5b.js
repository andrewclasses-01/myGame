// =============================================================
// MẪU 5b (thầy 26/9/2026): như 5, dùng game5b (tàu đặt thẳng ngay, kết trận nhanh + máy quay xoay đều), tiếng START nổ thật (sound-5b).
...
import { makeRocket, DEFAULT_TEAMS as TEAMS } from "../game5b/rr3d-view.js";   // mẫu 5: tàu giống hệt game (bản rẽ nhánh)   // tàu giống hệt game mới nhất
