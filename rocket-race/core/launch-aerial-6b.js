// MẪU 6b (26/9/2026): y hệt launch-aerial-5c.js, chỉ đổi tàu sang game6b (đội 2 CAM).
// =============================================================
// MẪU 5c (thầy 26/9/2026: "hiệu suất, độ mượt, nhạy tối đa" khi chạy trong myActivity trên TOMKO) — HÌNH Y HỆT 5b, chỉ nhẹ đi:
// giới hạn 60 khung (như cảnh đua) · TỰ GIỮ 60 khung (auto-res.js: hạ/nâng độ nét theo sức máy, sàn 0,8) · BÓNG ĐỔ vẽ lại chỉ khi
// có vật đổ bóng đang di chuyển (tay kẹp + tàu cất cánh; trước đây vẽ lại mỗi khung) · mây sắp xếp 2 khung/lần · DỊCH SẴN shader lửa
// + vệt nhảy tốc độ ở màn chờ (trước đây dịch lần đầu đúng lúc đánh lửa/nhảy ⇒ khựng).
// Kế thừa MẪU 5b (thầy 26/9/2026): như 5, dùng game5b (tàu đặt thẳng ngay, kết trận nhanh + máy quay xoay đều), tiếng START nổ thật (sound-5b).
// Kế thừa MẪU 5 (thầy 26/9/2026) — GAME HOÀN CHỈNH: intro nối liền ván đua (bản game rẽ nhánh rocket-race/game5/).
...
import { makeRocket, DEFAULT_TEAMS as TEAMS } from "../game6b/rr3d-view.js";   // mẫu 6: đội 2 CAM
import { makeAutoRes } from "./auto-res.js";   // mẫu 5: tàu giống hệt game (bản rẽ nhánh)   // tàu giống hệt game mới nhất
