...
export function createMissiles(X) {
  ...
  const MC = Object.assign({ dur: 3.8, window: 1.5, ammoCm: 8.5, boostCm: 2.6, gapCm: 0.7, alarm: "a", burnSecs: 8, carry: 0.32 }, cfg.missiles || {});
  ...
  const ALARM = { a: [1.05, 0.42], b: [0.95, 0.4], c: [1.0, 0.5] };
