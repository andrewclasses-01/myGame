...
const NAMES = ["ambient", "engine", "fire", "boost", "stall", "hit1", "hit2", "hit3", "boom", "boomlow",
  ...
  "malarm_a", "malarmf_a", "malarm_b", "malarmf_b", "malarm_c", "malarmf_c"];   // mẫu 6d: chuông báo động 3 kiểu (tools/tao-am-thanh-6d.py)
...
const BASE = { ambient: 0.45, engine: 0.32, fire: 0.55, boost: 0.8, stall: 0.85, hit1: 0.95, hit2: 0.95, hit3: 0.95,
  ...
  malarm_a: 0.7, malarmf_a: 0.75, malarm_b: 0.65, malarmf_b: 0.7, malarm_c: 0.6, malarmf_c: 0.65 };
