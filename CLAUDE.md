...
rocket-race/
  ...
  game6d/ + core/launch-aerial-6d.js                       MẪU 6d (mới nhất): nạp tay, quả to lùi khỏi màn, chuông báo động (tools/tao-am-thanh-6d.py), vết cháy, MISS WAIT 3D (rr3d-misswait.js)
